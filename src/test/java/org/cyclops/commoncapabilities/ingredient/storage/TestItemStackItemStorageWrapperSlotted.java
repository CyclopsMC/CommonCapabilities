...
public class TestItemStackItemStorageWrapperSlotted {
    ...
    public void testExtractItem() {
        assertThat(eq(wrapper.extractItem(2, 10, true), APPLE_1_0), is(true));
        assertThat(eq(wrapper.extractItem(4, 10, true), APPLE_1_10), is(true));
        assertThat(eq(wrapper.extractItem(6, 10, true), APPLE_10_10), is(true));

        assertThat(eq(wrapper.extractItem(2, 10, false), APPLE_1_0), is(true));
        assertThat(eq(wrapper.extractItem(2, 10, false), ItemStack.EMPTY), is(true));
        assertThat(eq(wrapper.extractItem(4, 10, false), APPLE_1_10), is(true));
