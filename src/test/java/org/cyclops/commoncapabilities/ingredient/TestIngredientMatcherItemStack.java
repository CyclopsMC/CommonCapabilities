...
public class TestIngredientMatcherItemStack {
    ...
    public void testCompare() {
        ...
        assertThat(M.compare(W_1, L_1), is(-920));
        assertThat(M.compare(W_1, L_1_T1), is(-920));
        ...
        assertThat(M.compare(W_1_T1, L_1), is(-920));
        assertThat(M.compare(W_1_T1, L_1_T1), is(-920));
        ...
        assertThat(M.compare(W_1_T2, L_1), is(-920));
        assertThat(M.compare(W_1_T2, L_1_T1), is(-920));
        ...
        assertThat(M.compare(W_2, L_1), is(-920));
        assertThat(M.compare(W_2, L_1_T1), is(-920));
        ...
        assertThat(M.compare(W_2_T2, L_1), is(-920));
        assertThat(M.compare(W_2_T2, L_1_T1), is(-920));

        assertThat(M.compare(L_1, W_1), is(920));
        assertThat(M.compare(L_1, W_1_T1), is(920));
        assertThat(M.compare(L_1, W_1_T2), is(920));
        assertThat(M.compare(L_1, W_2), is(920));
        assertThat(M.compare(L_1, W_2_T1), is(920));
        assertThat(M.compare(L_1, W_2_T2), is(920));
        assertThat(M.compare(L_1, L_1), is(0));
        assertThat(M.compare(L_1, L_1_T1), is(-1));

        assertThat(M.compare(L_1_T1, W_1), is(920));
        assertThat(M.compare(L_1_T1, W_1_T1), is(920));
        assertThat(M.compare(L_1_T1, W_1_T2), is(920));
        assertThat(M.compare(L_1_T1, W_2), is(920));
        assertThat(M.compare(L_1_T1, W_2_T1), is(920));
        assertThat(M.compare(L_1_T1, W_2_T2), is(920));
