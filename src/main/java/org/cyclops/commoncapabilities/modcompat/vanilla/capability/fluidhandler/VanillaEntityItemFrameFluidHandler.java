 ...
 * @author rubensworks
 */
public class VanillaEntityItemFrameFluidHandler extends VanillaEntityItemFrameCapabilityDelegator<ResourceHandler<FluidResource>> implements ResourceHandler<FluidResource> {
